  ...
  return (
    <div className="p-6 space-y-5 max-w-2xl" style={{ background: '#FAF8FF' }}>
      ...
      {property.description && (() => {
        const PREVIEW = 400;
        const isLong = property.description.length > PREVIEW;
        const displayed = showFullDesc || !isLong
          ? property.description
          : property.description.slice(0, PREVIEW).trimEnd() + '…';
        return (
          <div
          ...
          >
            ...
            <p className="text-sm leading-relaxed whitespace-pre-line" style={{ color: '#5A6280' }}>
              {displayed}
            </p>
            {isLong && (
              <button
        ...
        >
          <div className="space-y-0.5">
            ...
            {property.agent.agency && (
              <p className="text-xs" style={{ color: '#9DA3B8' }}>{property.agent.agency}</p>
            )}
